...
const LandlordProfileScreen = ({ navigation }) => {
  const { user, name, phone, role, email, logout } = useContext(AuthContext);
  ...
  const menuItems = [
    ...
    },
    {
      icon: "calendar-check",
      label: "Bookings",
      subtitle: "View tenant viewing requests",
      color: "#F59E0B",
    ...
    },
    {
      ...
      color: "#10B981",
      onPress: () => navigation.navigate("inc"),
    },
  ];
        ...
        <View className="bg-[#14213D] pt-6 pb-16 px-5 rounded-b-[32px]">
          ...
          <View className="items-center">
            ...
            <View className="bg-white/15 px-4 py-1.5 rounded-full mt-2 flex-row items-center">
              <View className="w-2 h-2 rounded-full bg-[#FCA311] mr-2" />
